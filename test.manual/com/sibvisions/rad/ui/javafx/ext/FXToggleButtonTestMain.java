...
public class FXToggleButtonTestMain extends Application
{
	...
	{
		FXToggleButton button = new FXToggleButton("Some text", new ImageView(new Image("http://upload.wikimedia.org/wikipedia/commons/6/6f/Icon-designed_using_vim.png")));
		...
		primaryStage.setTitle("JavaFX FXToggleButton Test");
		primaryStage.show();
	}
}
