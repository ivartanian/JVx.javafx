...
/**
 * A {@link ToggleButton} extension that allows to set the text alignment
 * relative to the displayed graphics node, if any.
 * 
 * @author Robert Zenz
 */
public class FXToggleButton extends ToggleButton implements IFXContentAlignable, IFXLayoutForwarding
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Class members
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 ...
	 */
	public FXToggleButton(String pText)
	{
		this(pText, null);
	}
