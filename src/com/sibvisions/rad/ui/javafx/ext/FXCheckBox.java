...
/**
 * An {@link CheckBox} extension that treats the checkbox as content if there is
 * no graphic node set, and also allows to align the text relative to the
 * content.
 * <p>
 ...
 * @author Robert Zenz
 */
public class FXCheckBox extends CheckBox implements IFXContentAlignable, IFXLayoutForwarding
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Class members
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 ...
	 */
	public FXCheckBox(String pText)
	{
		this(pText, null);
	}
	...
	{
		return LayoutUtil.computeContentPreferredHeight(this, this, this, "box");
	}
	...
	{
		return LayoutUtil.computeContentPreferredWidth(this, this, this, "box");
	}
	...
	{
		LayoutUtil.layoutContent(this, this, this, "box");
	}
